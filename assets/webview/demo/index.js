...
(function () {
    ...
    function init() {
        ...
        forwardCursorBtn = document.getElementById("forward-cursor-btn");
        ...
        openSheetMusicDisplay = new OpenSheetMusicDisplay(canvas, {
            ...
            drawFingerings: true,
            fingeringPosition: "above", // left is default. try right. experimental: auto, above, below.
            ...
            defaultColorStem: "#BB0099", // 	#B22222

            autoBeam: true, // try true, OSMD Function Test AutoBeam sample
            autoBeamOptions: {
                beam_rests: true,
                beam_middle_rests_only: true,
                //groups: [[3,4], [1,1]],
        ...
        forwardCursorBtn.addEventListener("click", function () {
            openSheetMusicDisplay.cursor.next();
        });
    ...
    function selectSampleOnChange(str) {
        ...
        openSheetMusicDisplay.setOptions({
            autoBeam: str.includes("autobeam")
        });
        openSheetMusicDisplay.setOptions({
            drawPartAbbreviations: !str.includes("Schubert_An_die_Musik")
        }); // TODO weird layout bug here. but shouldn't be in score anyways
