...
abstract class BleDevice {
  ...
  String id;
  int counter = 0;
  DeviceCategory _category = DeviceCategory.other;
  ...
  @override
  bool operator ==(other) =>
      other is BleDevice && compareAsciiLowerCase(this.name, other.name) == 0 && this.id == other.id;
...
class DisconnectedBleDevice extends BleDevice {
  StreamController<BleDevice> _devicesInConnectingProcess = StreamController();
