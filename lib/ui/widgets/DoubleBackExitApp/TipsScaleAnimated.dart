...
class TipsScaleAnimated extends AnimatedWidget {
  ...
  TipsScaleAnimated({Key? key, required this.child, required this.animation}) : super(key: key, listenable: animation);

  Widget build(BuildContext context) {
    final Animation<double> _animation = listenable as Animation<double>; // 获取动画监听对象animation
